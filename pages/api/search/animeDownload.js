...
export default async function handler(req, res) {
  ...
  try {
    const downloadLinks = await nontonAnime.download(downloadUrl);
      ...
      $(".mirror option").each((_, element) => {
        ...
        if (encodedValue) {
          try {
            ...
            const decodedLink = buffer.toString("utf-8").trim();
            ...
            console.error("Error decoding base64 link:", decodeError);
          }
        }
      });
